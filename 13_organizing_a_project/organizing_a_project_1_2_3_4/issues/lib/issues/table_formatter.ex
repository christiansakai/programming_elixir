defmodule Issues.TableFormatter do
  ...
  @doc """
  Given a list containing sublists, where each sublist
  contains the data for a column, return a list containing
  ...
  @doc """
  Return a format string that hard codes the width
  of a set of columns. We put " | " between each column.
  ...
  @doc """
  Given a list containing rows of data, a list containing
  the header selectors, and a format string, write the
  extracted data under control of the format string.
  """
